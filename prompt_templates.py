...
- The length of the blog post should be roughly 500 words.
...
- Use subheadings,  quotes, or other elements to break up the text and make it easier to read.
...
- The output format of the entire blog post must be in Markdown. All headings, links, etc. must use proper Markdown syntax
